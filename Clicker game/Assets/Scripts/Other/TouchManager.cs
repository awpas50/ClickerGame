...
public class TouchManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Input.GetTouch(0).phase == TouchPhase.Moved && (Input.GetTouch(0).deltaPosition.x >= 5f || Input.GetTouch(0).deltaPosition.x <= -5f || Input.GetTouch(0).deltaPosition.y >= 5f || Input.GetTouch(0).deltaPosition.y <= -5f))
            {
                isDragging = true;
            }
